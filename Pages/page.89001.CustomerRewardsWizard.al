page 89001 "Customer Rewards Wizard"
{
    ...
    layout
    {
        area(content)
        {
            ...
            // You can use other names, but the principle is that you should create one group for every step that you want to have 
            ...
            action(ActionActivate)
            {
                ...
                begin
                    ...
                    if CustomerRewardsExtMgt.ActivateCustomerRewards(ActivationCode) then
                        NextStep(false) // move to next steps
                    else
